...
<body>
	...
	<section class="contact " >
		<div class="container">
	        <form class="row  login" method="POST" action="<?php echo site_url('Co_login/masukuser');?>">
				...
				<h4>Belum melakukan pendaftaran? Silahkan <a href="<?php echo site_url("panggil/daftar")?>">klik disini!</a></h4>
